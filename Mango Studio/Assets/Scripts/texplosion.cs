...
namespace Tutorial{
public class texplosion : MonoBehaviour {
	public int type;
	private texpModel model;
	...
	public void init (Vector3 pos, int ptype) {
		...
		model = modelObject.AddComponent<texpModel>();					// Add a marbleModel script to control visuals of the gem.
		model.init(this);
