...
namespace Tutorial{
public class tBossBeam : MonoBehaviour {

	private tBossBeamModel model;
	private tBoss m;
	private float speed;
	private int health;
	...
	public void init (tBoss boss) {
		...
		model = modelObject.AddComponent<tBossBeamModel>();						// Add a marbleModel script to control visuals of the gem.
		model.init(this);
