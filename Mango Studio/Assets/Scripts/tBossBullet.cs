...
namespace Tutorial{
public class tBossBullet : MonoBehaviour {
	
	private tBossBulletModel model;
	private float speed;
	private tBoss owner;
	...
	public void init (tBoss boss) {
		...
		model = modelObject.AddComponent<tBossBulletModel>();						// Add a marbleModel script to control visuals of the gem.
		model.init(this);
