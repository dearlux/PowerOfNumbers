...
namespace Tutorial{
public class tBossShield : MonoBehaviour {

	private tBoss m;
	private int ShieldHealth;
	public tBossShieldModel model;
	...
	public void init (tBoss owner){
		...
		model = modelObject.AddComponent<tBossShieldModel>();						// Add a marbleModel script to control visuals of the gem.
		model.init(this);
